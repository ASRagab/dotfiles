# Generated by Powerlevel10k configuration wizard on 2021-05-08 at 13:16 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_ASDF_NODEJS_SHOW_ON_UPGLOB='*.ts|*.tsx|*.js|*.jsx|package.json'
